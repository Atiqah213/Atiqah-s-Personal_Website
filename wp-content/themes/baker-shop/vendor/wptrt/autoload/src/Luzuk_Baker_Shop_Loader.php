...
class Luzuk_Baker_Shop_Loader {
	 ...
	 * @return void
	 */
	public function luzuk_baker_shop_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function luzuk_baker_shop_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function luzuk_baker_shop_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function luzuk_baker_shop_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->luzuk_baker_shop_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function luzuk_baker_shop_load( $class ) {
