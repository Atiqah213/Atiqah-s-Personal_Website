...
class Adventure_Camping_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'adventure-camping' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $adventure_camping_font_awesome_icon_array = adventure_camping_font_awesome_icon_array();
                    foreach ($adventure_camping_font_awesome_icon_array as $adventure_camping_font_awesome_icon) {
                            $icon_class = $this->value() == $adventure_camping_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($adventure_camping_font_awesome_icon).'"></i>
                            <span class="adventure-camping-social-class">'.esc_attr($adventure_camping_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function adventure_camping_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'adventure-camping-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'adventure_camping_customizer_script' );

if(!function_exists('adventure_camping_font_awesome_icon_array')){
    function adventure_camping_font_awesome_icon_array(){
