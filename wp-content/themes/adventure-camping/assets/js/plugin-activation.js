jQuery(document).ready(function($) {
    'use strict';
    var this_obj = adventure_camping_plugin_activate_plugin;

    $(document).on('click', '.adventure-camping-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message adventure-camping-plugin-install');
                button.addClass('button-primary adventure-camping-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.adventure-camping-recommended-plugins .adventure-camping-activation-note').css('display','block');
    ...
    $(document).on('click', '.adventure-camping-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .adventure-camping-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .adventure-camping-recommended-plugins').css('display','none');
    });
