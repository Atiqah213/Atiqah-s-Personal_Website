...
<div id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="post-main-box p-3 mb-5 wow zoomInUp delay-1000" data-wow-duration="2s">
    <?php $adventure_camping_theme_lay = get_theme_mod( 'adventure_camping_blog_layout_option','Left');
    if($adventure_camping_theme_lay == 'Default'){ ?>
      <div class="row">
        <?php if(has_post_thumbnail() && get_theme_mod( 'adventure_camping_featured_image_hide_show',true) == 1) {?>
          <div class="box-image col-lg-6 col-md-6">
            <?php the_post_thumbnail(); ?>
          </div>
        <?php } ?>
        <article class="new-text <?php if(has_post_thumbnail() && get_theme_mod( 'adventure_camping_featured_image_hide_show',true) == 1) { ?>col-lg-6 col-md-6" <?php } else { ?>col-lg-12 col-md-12" <?php } ?>>
          ...
          <?php if( get_theme_mod('adventure_camping_button_text','Read More') != ''){ ?>
            <div class="more-btn mt-4 mb-4">
              <a class="p-3" href="<?php the_permalink(); ?>"><?php echo esc_html(get_theme_mod('adventure_camping_button_text',__('Read More','adventure-camping')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('adventure_camping_button_text',__('Read More','adventure-camping')));?></span><span class="top-icon"></span></a>
            </div>
          <?php } ?>
        </article>
      </div>
    <?php }else if($adventure_camping_theme_lay == 'Center'){ ?>
      <div class="service-text">
        ...
        <?php if( get_theme_mod( 'adventure_camping_featured_image_hide_show',true) == 1) { ?>
          <div class="box-image">
            <?php the_post_thumbnail(); ?>
          </div>
        <?php } ?>
    ...
    <?php }else if($adventure_camping_theme_lay == 'Left'){ ?>
      <div class="service-text">
        <?php if( get_theme_mod( 'adventure_camping_featured_image_hide_show',true) == 1) { ?>
          <div class="box-image">
            <?php the_post_thumbnail(); ?>
