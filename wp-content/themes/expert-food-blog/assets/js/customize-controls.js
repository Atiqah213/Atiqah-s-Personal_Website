( function( $ ) {
  var this_obj = expert_food_blog_customizer_params;
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'expert_food_blog_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'expert_food_blog_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'expert_food_blog_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      if (
        'expert_food_blog_section' !== this.params.type ||
...
(function (api) {
  ...
  api.Tab = api.Control.extend({
    ready: function () {
      var control = this;
      control.container.find('a.expert-food-blog-customizer-tab').click(function (evt) {
        var tab = jQuery(this).data('tab');
        evt.preventDefault();
        control.container.find('a.expert-food-blog-customizer-tab').removeClass('active');
