...
if ( class_exists( 'WP_Customize_Control' ) ) :
     ...
     * @since 1.0.0
     */
	class Expert_Food_Blog_Control_Upgrade extends WP_Customize_Control {
        ...
        protected function content_template() {
            ?>
                <div class="mt-upgrade-pro-wrapper">
                    ...
                    <# } #>
                    <a class="mt-upgrade-btn" href="<?php echo esc_url( EXPERT_FOOD_BLOG_PRO_THEME_URL ); ?>" target="_blank"><?php esc_html_e( 'upgrade to pro', 'expert-food-blog' ); ?></a>
                    <a class="mt-upgrade-btn-bundle" href="<?php echo esc_url( EXPERT_FOOD_BLOG_THEME_BUNDLE_URL ); ?>" target="_blank"><?php esc_html_e( 'Buy All Themes', 'expert-food-blog' ); ?></a>
