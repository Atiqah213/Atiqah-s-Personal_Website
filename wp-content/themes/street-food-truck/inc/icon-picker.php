...
class Street_Food_Truck_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'street-food-truck' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $street_food_truck_font_awesome_icon_array = street_food_truck_font_awesome_icon_array();
                    foreach ($street_food_truck_font_awesome_icon_array as $street_food_truck_font_awesome_icon) {
                            $icon_class = $this->value() == $street_food_truck_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($street_food_truck_font_awesome_icon).'"></i>
                            <span class="street-food-truck-social-class">'.esc_attr($street_food_truck_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function street_food_truck_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'street-food-truck-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'street_food_truck_customizer_script' );

if(!function_exists('street_food_truck_font_awesome_icon_array')){
    function street_food_truck_font_awesome_icon_array(){
