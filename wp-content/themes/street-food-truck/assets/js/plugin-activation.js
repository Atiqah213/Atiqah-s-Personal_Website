jQuery(document).ready(function($) {
    'use strict';
    var this_obj = street_food_truck_plugin_activate_plugin;

    

    $(document).on('click', '.street-food-truck-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message street-food-truck-plugin-install');
                button.addClass('button-primary street-food-truck-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.street-food-truck-recommended-plugins .street-food-truck-activation-note').css('display','block');
    ...
    $(document).on('click', '.street-food-truck-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .street-food-truck-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .street-food-truck-recommended-plugins').css('display','none');
    });
